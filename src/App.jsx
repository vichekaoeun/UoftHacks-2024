...
function App() {
  ...
  useEffect(() => {
    async function fetchWeather() {
      try {
        const response = await fetch("https://api.weatherapi.com/v1/current.json?key=ae4c4fac8b7e43609bd173829242701&q=toronto");
  ...
  return (
    <Auth0Provider
      domain="dev-1zd7xmkj0eqmiekq.us.auth0.com"
      clientId="oz2q4fmPfDB0DkFLDNIJFjXDofkLN2kI"
        ...
        <div id='content'>
          <div className='content-item'>
            ...
            <div id='journal-content'>
              ...
              <div className='journal-item'>
                <div id='journal-image'>
                  <img src='./vacation.jpg'></img>
                </div>
                <div id='journal-stuff'>
                  <div>
                    Vacation with some friends!
                  </div>
                  <div>
                    Mood: 5
                  </div>
